...
admin.site.site_header = "INGU"
admin.site.site_title = "INGU Admin Portal"
admin.site.index_title = "INGU Admin"

# swagger
api_info = openapi.Info(
    title="INGU API",
    default_version="v1",
    description="API documentation for INGU App",
)
